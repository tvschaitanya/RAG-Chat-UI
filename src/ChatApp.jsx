        ...
        <footer className="bg-white border-t border-gray-100 p-3 safe-area-pb">
          <form onSubmit={sendMessage} className="flex gap-2 items-center">
            ...
            <button
              ...
              className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 disabled:opacity-50 disabled:bg-gray-200 transition-colors shadow-sm"
            >
